...
int main(int argc, char *argv[]) {
  ...
  unsigned char	*ima_local, *pima_local;
  ...
  /* Calcul dimension image locale */ 
  if (h % p != 0) {
		printf("Erreur : La hauteur n'est pas un multiple du nombre de processus. \n \
			Veuillez changer le nombre de processus! \n");
		MPI_Finalize();
		return 0;
  }
  h_local = h / p; 
